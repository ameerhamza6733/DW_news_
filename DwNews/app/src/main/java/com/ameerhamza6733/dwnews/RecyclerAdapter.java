...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (!new MySharedPreferences().loadPrefs(Constants.switchStateKey, true, holder.mview.getContext())) {
            Picasso.with(rssItem.getContext())
                    .load(rssItem.getImageUrl())
//                    .placeholder(R.drawable.back_ground_image)
                    .fit()
                    .into(holder.mImage);
            Log.i("Inside in picasso", Boolean.toString(mySwitchIsChecked));
    ...
    private void showPopupMenu(View view, int position) {
     ...
     if(mDataSet.get(position).getCategory().equals("") || HalatHazraFragment.isHalatHazraFragmentVisible)
     {
