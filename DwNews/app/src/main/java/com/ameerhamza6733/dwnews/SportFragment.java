...
/**
 * Created by DELL 3542 on 7/29/2016.
 */
public class SportFragment extends Fragment {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && mDataset.isEmpty()) {
            ...
            new LoadRssFeedsItems(getActivity()).execute(Constants.SPORT);
        }
    ...
    public class LoadRssFeedsItems extends AsyncTask<String, Integer, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            if (mDataset.isEmpty()) {
              try {
                  Snackbar mSnackbar = Snackbar.make(view, "Unable to connect   sport ", Snackbar.LENGTH_LONG)
